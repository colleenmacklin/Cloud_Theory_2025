...
public class CloudManager_new : MonoBehaviour
{
    [Range(0f, 40f)]
    ...
    */
    ...
    void OnDrawGizmos()
    {
        ...
        Vector3 gv3 = new Vector3(poissonRegionSize.x, 0, poissonRegionSize.y); //scale
        Vector3 gv3half = new Vector3(gv3.x / 2, _y, gv3.z / 2); //center point
        Vector3 region_shift = new Vector3(gv3.x- poissonRegionSize.x, _y, gv3.z- poissonRegionSize.y);
